...
<div class='row'>
	<div class='col-md-12'>
		...
		<!-- Basic legend -->
		<form class='form-horizontal' id='formAdd' name='formAdd' action='".base_url("admin/produk/edit_data")."' method='post'>
						...
						<div class='col-lg-9'>
							<div class='media no-margin-top'>
								<div class='media-left'>";
									...
									<img id='img_pic_cover_1' class='images' src='".base_url("".$img_src."")."' style='cursor:pointer; width: 100px; height: 100px;' class='img-rounded' alt='' style='cursor:pointer;width:150px; height:150px' onclick=javascript:click_picture('pic_cover_1')>
						...
						<div class='col-lg-9'>
							<div class='media no-margin-top'>
								...
								foreach($getImageDetail->result() as $imageDetail){
									echo"
								<div class='media-left'>
									<img id='img_pic_edit_".$imageDetail->id."' class='images' src='".base_url($imageDetail->product_img)."' style='cursor:pointer; width: 100px; height: 100px;' class='img-rounded' alt='' style='cursor:pointer;width:150px; height:150px' onclick=javascript:click_picture('pic_edit_".$imageDetail->id."')>
									<input type='file' class='pic_product'  name='pic_edit_".$imageDetail->id."' id='pic_edit_".$imageDetail->id."' style='opacity: 0.0;width:1px; height:1px' OnChange=javascript:picture_upload(this.id,image_high_edit_".$imageDetail->id.",image_tumb_edit_".$imageDetail->id.",".$imageDetail->id.")>                                <input id='image_high_edit_".$imageDetail->id."' name='image_high_edit_".$imageDetail->id."' type='hidden'/>
