...
<style>
  body{
	...
	<table width='100%' cellspacing='0'>
		<td><b style='margin-top:0.3mm; font-size: 15px;'>".strtoupper($getPerusahaan->name)."</b></td>
		<td><b style='margin-top:0.3mm; font-size: 10px;'>The Specialist For Engine Parts</b></td>
		<td align='right'><b style='margin-top:0.3mm; font-size: 15px;'>".$getInvoice->nonota."</b></td>
	</table>
	<hr style='margin-top:1px'>
	<table width='100%' cellspacing='0'>
		<tr>
			<td width='70%' style='height: 2px; vertical-align: top;'>
				<table width='100%'>
				<tr>
					<td width='50%' style='height: 2px; vertical-align: top;'>
						<table width='100%'>
								<tr>
									<td style='height: 2px; vertical-align: top;'><b>Kepada Yth : &nbsp; &nbsp; <i>".strtoupper($getInvoice->member_id)."</i></b></td>
								</tr>
								<tr>
			...
			<td width='25%' style='height: 2px; vertical-align: top;'>
				<table width='100%'>
				<tr>
					<td width='50%' style='height: 2px; vertical-align: top;'>
						<table width='100%'>
								<tr>
									...
									echo"
									<td align='right' style='height: 2px; vertical-align: top;' align='left'><b><b> ".$hari[$num].", ".date("d M Y",strtotime("+0 day", strtotime($changeTanggal)))."</b></b></td>
								</tr>
								<tr>
									<td></td>
								</tr>
