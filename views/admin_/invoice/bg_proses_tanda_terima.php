...
<div class='content-wrapper'>
	...
	<div class='panel panel-flat'>
		<div class='panel-heading'>
			<h5 class='panel-title'>Halaman No Tanda Terima <b>".$this->uri->segment(4)."</b> Customer <b>".$getPiutang->row()->nama_member." - ".$getPiutang->row()->kota_member."</b></h5>
		...
		<table class='table datatable-basic'>
			...
			foreach($Data->result() as $data){
				...
				<tr>
					<td>$no</td>
					<td><a href='".base_url("admin/invoice/retur_revisi/".base64_encode($data->id_nota)."")."'>".$data->no_nota."</a></td>
		...
		<fieldset>
			...
			<div class='form-group' id='tempatGiroCek' style='display:none'>
				...
				<div class='col-lg-10'>
					<div class='row'>
						<div class='col-md-3'>
							<input class='form-control' id='tanggal_cair' name='tanggal_cair' type='date' >
						</div>
