...
<div class='content-wrapper'>
	...
	<div class='panel panel-flat'>
		...
		<div style='margin-left:1%;display:none' id='btnExport'>
			<a href='".base_url("admin/invoice/print_report_rekap_invoice/print")."' target='_blank' class='btn btn-primary btn-labeled'><b><i class='icon-printer'></i></b> Print </a>
			<a href='".base_url("admin/invoice/print_report_rekap_invoice/excel")."' target='_blank' class='btn bg-green'><i class=' icon-file-download2 position-left'></i>Export Excel</a>
			<a href='".base_url("admin/invoice/print_report_rekap_invoice/pdf")."' target='_blank' class='btn btn-danger'><i class='icon-file-download position-left'></i>Export PDF</a>
		</div>
		<table class='table'>
			<thead>
				<tr>
