			...
			<td width='35%' style='height: 2px; vertical-align: top;'>
				...
				<tr>
					<td width='50%' style='height: 2px; vertical-align: top;'>
						<table width='100%'>
								<tr>
									<td style='height: 2px; vertical-align: top;' align='left'><b><b>Faktur No : ".$getInvoice->nonota."</b></b></td>
								</tr>
								<tr>
									";
									...
									echo"
									<td style='height: 2px; vertical-align: top;' align='left'><b><b>Hari/Tgl : ".$hari[$num].", ".date("d M Y",strtotime("+0 day", strtotime($changeTanggal)))."</b></b></td>
								</tr>
								<tr>
