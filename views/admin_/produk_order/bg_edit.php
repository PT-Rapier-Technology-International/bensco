                    ...
                    <div class='col-md-8'>
                        <div class='form-group' id='inpManual'>
                            <label>Scan Barcode : </label>
                                <input type='text' id='kode_produk' name='kode_produk' class='form-control input-xlg' placeholder='Input Kode Barcode' autofocus='' onchange='javascript:scan_barcode_order_edit(".base64_decode($id).");'>
                        </div>
                        <div class='form-group' style='display:none' id='inpBarcode'>
                            <label>Pilih Produk : </label>
                                <select id='cmbProduk' name='cmbProduk' class='form-control' onchange=javascript:scan_manual_barcode_order_edit(".base64_decode($id).")>
        ...
        foreach($getDataDetail->result() as $detail){
            echo"
               <tr>
                    ...
                    <td width='25%'>
                        <input type='text' id='addStok_kali_".$detail->id."' name='addStok_kali_".$detail->id."' value='".$detail->qty."' class='form-control' style='display: block;' readonly>
                    </td>
                    <td width='25%'>
