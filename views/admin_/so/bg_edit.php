...
<div class='content-wrapper'>
    ...
    <div class='panel panel-white'>
                    ...
                    <div class='col-md-8'>
                        <div class='form-group' id='inpManual'>
                            <label>Scan Barcode : </label>
                                <input type='text' id='kode_produk' name='kode_produk' class='form-control input-xlg' placeholder='Input Kode Barcode' autofocus='' onchange='javascript:scan_barcode_so_edit(".$getData->id.");'>
                        </div>
                        <div class='form-group' style='display:none' id='inpBarcode'>
                            <label>Pilih Produk : </label>
                                <select id='cmbProduk' name='cmbProduk' class='form-control' onchange=javascript:scan_manual_so_edit(".$getData->id.")>
        ...
        <div class='text-right'>
            ...
            <button type='button' onclick=javascript:simpanEditPembuatanSO(".$getData->id.") class='btn btn-success btn-labeled'><b><i class='icon-floppy-disk'></i></b> Simpan</button>
            ";}
            }echo"
