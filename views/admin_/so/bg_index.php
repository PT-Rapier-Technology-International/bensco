...
<div class='content-wrapper'>
				...
				<div class='panel panel-flat'>
					<div class='panel-heading'>
						<h5 class='panel-title'>Stock Opname</h5>
					...
					if($_SESSION['rick_auto']['flag_user'] == 3 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 1){
						echo"<a href='".base_url("admin/produk/so_add")."' class='btn btn-info btn'>Tambah Stock Opname</a>";
					}else{
						echo"
						";
					}echo"
						...
						<table class='table datatable-basic'>
							...
							foreach($getData->result() as $data){
								...
								<tr>
									...
									<td><a href='".base_url("admin/produk/so_edit/".base64_encode($data->id)."")."' class='btn btn-primary btn-labeled'><b><i class='icon-make-group'></i></b> Detail Data</a><br><br>
