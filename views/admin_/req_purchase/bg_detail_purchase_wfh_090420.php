    ...
    <table class='table table-lg'>
        ...
        <tbody>
            ...
            <tr>
            	...
            	<td class='text-right'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format($purchaseDetail->price,2,',','.')."";}echo"
                </td> 
                ...
                <input type='text' id='txtTotalSatuan_".$purchaseDetail->id."' name='txtTotalSatuan_".$purchaseDetail->id."' value='".$purchaseDetail->price."' class='form-control'>
                <div align='right'>
                ...
                <td id='lbltdDiskon_".$purchaseDetail->id."' class='text-right'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"<a href='#!' onclick=javascript:editAjax(".$purchaseDetail->id.",'tdDiskon_".$purchaseDetail->id."')>0</a>";}echo"
                </td>   
                <td id='txttdDiskon_".$purchaseDetail->id."' style='display:none'>
                <input type='text' id='txtDiscount_".$purchaseDetail->id."' name='txtDiscount_".$purchaseDetail->id."' value='0' class='form-control'>
                <div align='right'>
                ...
                ";}echo"
                <td class='text-right'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format($purchaseDetail->ttl_price,2,',','.')."";}echo"
                </td> 
...
<div class='panel-body'>
	...
	<p class='text-muted'><h2>Terima Kasih</h2><br>
	";
