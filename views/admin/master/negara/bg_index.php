...
<div class='content-wrapper'>
				...
				<div class='panel panel-flat'>
					<div class='panel-heading'>
						<h5 class='panel-title'>List Master Negara</h5>
					...
					<div class='panel-body'>
						<a href='".base_url("admin/master/addNegara")."' class='btn btn-info btn'>Tambah Negara</a>
					</div>
...
<script type="text/javascript">
    var table;
        ...
        table = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/master/getDataNegara')?>",
                "type": "POST"
            },
