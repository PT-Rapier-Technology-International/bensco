		...
		<form class='form-horizontal' id='formAdd' name='formAdd'>
			<div class='panel panel-flat'>
				<div class='panel-heading'>
					<h5 class='panel-title'>Edit Via Expedisi<a class='heading-elements-toggle'><i class='icon-more'></i></a></h5>
				...
				<div class='panel-body'>
					<fieldset>
						<legend class='text-semibold'>Form Edit Via Expedisi</legend>
					...
					<div class='text-right'>
						<button type='button' class='btn btn-primary' onclick=javascript:simpan_edit_data('via_expedisi',".$getData->id.")>Simpan Data <i class='icon-arrow-right14 position-right'></i></button>
					</div>
				</div>
			</div>
		</form>
