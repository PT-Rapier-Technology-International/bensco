...
<div class='content-wrapper'>
				...
				<div class='panel panel-flat'>
					<div class='panel-heading'>
						<h5 class='panel-title'>List Master Provinsi</h5>
					...
					<div class='panel-body'>
						<a href='".base_url("admin/master/addProvinsi")."' class='btn btn-info btn'>Tambah Provinsi</a>
					</div>
...
<script type="text/javascript">
    var table;
        ...
        table = $('#example').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/master/getDataProvinsi')?>",
                "type": "POST"
            },
