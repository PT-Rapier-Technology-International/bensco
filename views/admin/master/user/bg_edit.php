...
if($param_jenis == 0){
    $jn_user = "user";
    $kd = $getData->id;
}elseif($param_jenis == 1){
    $jn_user = "member";
    $kd = $getData->uniq_code;
}else{
    $jn_user = "sales";
    $kd = $getData->id;
}
		...
		<form class='form-horizontal' id='formAdd' name='formAdd'>
			<div class='panel panel-flat'>
				<div class='panel-heading'>
					<h5 class='panel-title'>Edit ".ucfirst($jn_user)."<a class='heading-elements-toggle'><i class='icon-more'></i></a></h5>
				...
				<div class='panel-body'>
					<fieldset>
						<legend class='text-semibold'>Form Edit ".ucfirst($jn_user)."</legend>
						<div class='form-group'>
							<label class='col-lg-3 control-label'>Kode</label>
							<div class='col-lg-9'>
                                <input type='text' name='kode' id='kode' class='form-control' palceholder='Masukkan Kode' value='".$kd."' readonly>
                            </div>
            			</div>
						<div class='form-group'>
