		...
		<form class='form-horizontal' id='formAdd' name='formAdd'>
			<div class='panel panel-flat'>
				<div class='panel-heading'>
					<h5 class='panel-title'>Tambah ".$jenis." ".$jn_user."<a class='heading-elements-toggle'><i class='icon-more'></i></a></h5>
				...
				<div class='panel-body'>
					<fieldset>
						<legend class='text-semibold'>Form Tambah ".$jenis." ".$jn_user."</legend>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-lg-9'>
                                <input type='text' name='phone' id='phone' class='form-control' palceholder='Masukkan Hp' >
                            </div>
                        </div>
                        <div class='form-group'>
                        ...
                        if($param_jenis == 1 || $param_jenis == 7){
                            $jen = "NPWP";
                        }else{
                            $jen = "";
                        }echo"
            			...
            			<div class='form-group'>
							...
							<div class='col-lg-9'>
                                <select id='cmbCity' name='cmbCity' data-placeholder='Pilih Kota Produk' class='select select2-hidden-accessible' tabindex='-1' aria-hidden='true' onchange=javascript:getSingkatan()>
                                ";
                        ...
                        </div>";}elseif($param_jenis == 1 || $param_jenis == 7){
            				echo"
            			<div class='form-group'>
            				...
            				echo"
                        <div class='form-group' id='tempatInputKode'>
                            <label class='col-lg-3 control-label'>Kode</label>
                            <div class='col-lg-9'>
					...
					<div class='text-right'>
						<button type='button' class='btn btn-primary' onclick=javascript:simpan_user_data(".$param_jenis.",'".base64_encode($jenis)."','".$jenis."','".base64_encode($jenis_user)."')>Simpan Data <i class='icon-arrow-right14 position-right'></i></button>
					</div>
				</div>
			</div>
		</form>
