...
echo"
	<div class='modal-header'>
		...
		<h5 class='modal-title'>Invoice #".$getInvoice->nonota."</h5>
	</div>
		...
		<div class='row'>
			<div class='col-md-6 col-lg-9 content-group'>
				<span class='text-muted'>Invoice To:</span>
					<ul class='list-condensed list-unstyled'>
					<li><h5>".$getInvoice->member_name." - ".$getInvoice->kota_member."</h5></li>
					...
					<div class='table-responsive no-border'>
						<table class='table'>
							<tbody>
								...
								<tr>
									<th>Total:</th>
									<td class='text-right text-primary'><h5 class='text-semibold'>Rp. ".number_format($getInvoice->total,2,',','.')."</h5></td>
								</tr>
							</tbody>
						</table>
					</div>
