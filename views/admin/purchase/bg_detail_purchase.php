	...
	<div class='row'>
		...
		<div class='col-md-6 col-lg-3 content-group'>
			...
			<ul class='list-condensed list-unstyled invoice-payment-details'>
				...
				<li><h5>Total Due: <span class='text-right text-semibold'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo" Rp. ".number_format(ceil($getPurchaseDetail->total_harga),2,',','.')."";}echo"</span></h5></li>
    ...
    <table class='table table-lg'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class='text-right'><span class='text-semibold'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format(ceil($totalSebelum),2,',','.')."";}echo"</span></td>

                <td class='text-right'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format(floor($purchaseDetail->price),2,',','.')."";}echo"</td>

                <td class='text-right'><span class='text-semibold'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format(ceil($purchaseDetail->ttl_price),2,',','.')."";}echo"</span></td>
						...
						<tbody>
							...
							<tr>
								...
								<td class='text-right'>";if($_SESSION['rick_auto']['flag_user'] == 3){
									...
									}else{echo"Rp. ".number_format(ceil($total_pembayaran),2,',','.')."";}echo"</td>
							...
							<tr>
								...
								<td class='text-right text-primary'><h5 class='text-semibold'>";if($_SESSION['rick_auto']['flag_user'] == 3){
									...
									}else{echo"Rp. ".number_format(ceil($total_pembayaran),2,',','.')."";}echo"</h5></td>
