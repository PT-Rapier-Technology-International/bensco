    ...
    <table class='table table-lg'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <input type='hidden' id='txtTotalSatuanRe_".$purchaseDetail->id."' name='txtTotalSatuanRe_".$purchaseDetail->id."' value='0' class='form-control'>

                <!--<input type='hidden' id='txtTotalSatuanRe_".$purchaseDetail->id."' name='txtTotalSatuanRe_".$purchaseDetail->id."' value='".$purchaseDetail->price."' class='form-control'>-->
