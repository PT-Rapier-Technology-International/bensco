	...
	<div class='panel panel-white'>
    	...
    	<div class='col-md-12'>
    		...
    		<div class='col-md-4'>
				<div class='form-group'>
					<label>Produk: </label>
                	<select id='cmbProduk_1' name='cmbProduk_1' class='form-control' onchange=javascript:getGudangFrom(1)>
    		...
    		<div class='col-md-3' id='tmpCmbGudang_1'>
				<div class='form-group'>
					<label>Dari Gudang : </label>
                	<div id='tempatGudang_1'>
			        <select class='form-control' id='cmbGudangFrom_1' name='cmbGudangFrom_1' >
			            <option value='0' selected>Pilih Gudang</option>
			        </select>
			        </div>
				</div>
    		</div>
            <div class='col-md-3' id='tmpCmbGudangTo_1'>
                <div class='form-group'>
                    <label>Tujuan Gudang : </label>
                    <div id='tempatGudang_1'>
                    <select class='form-control' id='cmbGudangTo_1' name='cmbGudangTo_1'>
                        <option value='0' selected>Pilih Gudang</option>
