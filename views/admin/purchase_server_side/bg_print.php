	    ...
	    <table width='100%' border='1' cellspacing='0'>
	        ...
	        <tbody>";
	            ...
	            <tr>
	                ...
	                <td align='center' style='font-size: 13px;'> ".$qtyKirimm." ".$detailInvoice->nama_satuan."
	                </td>

	                ";if($_SESSION['rick_auto']['flag_user'] == 3){echo"

	                <td align='center' style='font-size: 13px;'>".$detailInvoice->colly." - ".$detailInvoice->colly_to."</td>

	                <td>
	                	<table border='0' width='100%'>
	                		<tr>
	                			<td align='right' style='font-size: 13px;' width='70%'>".$detailInvoice->weight."</td>
	                			<td align='right' style='font-size: 13px;' width='30%'>Kg</td> 
	                		</tr>
	                	</table>
	                </td>
	                ...
	                <td align='right' style='font-size: 13px;' >";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format($detailInvoice->price,0,',','.')."";}echo"</td>

	                <td align='center' style='font-size: 13px;' >".$detailInvoice->discount." %</td>

	                <td align='right' style='font-size: 13px;' ><span class='text-semibold'>";if($_SESSION['rick_auto']['flag_user'] == 3){echo"";}else{echo"".number_format($detailInvoice->ttl_price,0,',','.')."";}echo"</span></td>";}echo"
