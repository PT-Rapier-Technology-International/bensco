...
<div class='content-wrapper'>
	...
	<div class='panel panel-white'>
    	...
    	<div class='col-md-12'>
    		...
    		<div class='col-md-6' style='background-color:#c5c5c5'>
				<div class='form-group'>
					<label>Produk: </label>
            ...
            <div class='col-md-2' style='background-color:#c5c5c5'>
                <div class='form-group'>
                    ...
                    <input type='text' id='addStokEdit_".$detail->id."' name='addStokEdit_".$detail->id."' value='0' class='form-control' style='display: block;'>
                </div>
            </div>
            ";
