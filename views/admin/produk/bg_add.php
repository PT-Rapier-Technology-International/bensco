				...
				<div class='panel-body'>
					<fieldset>
            			...
            			<div class='form-group'>
							...
							<div class='col-lg-9'>
                                <input type='text' placeholder='Masukkan Kode Produk Bayangan' class='form-control' id='kode_produk_bayangan' name='kode_produk_bayangan'>
                            </div>
            			</div>
            			<div class='form-group'>
            			...
            			<div class='form-group'>
							<label class='col-lg-3 control-label'>Harga Eskpor</label>
							<div class='col-lg-9'>
                                <input type='text' placeholder='Masukkan Harga Ekspor ex: 100.000' class='form-control' id='rupiah_input' name='harga_ekspor'>
                            </div>
            			</div>
						<div class='form-group'>
            			...
            			<div class='form-group'>
							<label class='col-lg-3 control-label'>QRCode 1</label>
							<div class='col-lg-9'>
								<div class='row'>
									<div class='col-md-4'>
										<input type='text' placeholder='Masukkan Qrcode' class='form-control' id='qrcode1' name='qrcode1'>
									</div>
									<label class='col-lg-3 control-label'>Isi 1</label>
									<div class='col-md-5'>
										<input type='text' placeholder='Masukkan Value' class='form-control' id='qrcode_value1' name='qrcode_value1'>
									</div>
								</div>
							</div>
						</div>
						<div class='form-group'>
							<label class='col-lg-3 control-label'>QRCode 2</label>
							<div class='col-lg-9'>
								<div class='row'>
									<div class='col-md-4'>
										<input type='text' placeholder='Masukkan Qrcode' class='form-control' id='qrcode2' name='qrcode2'>
									</div>
									<label class='col-lg-3 control-label'>Isi 2</label>
									<div class='col-md-5'>
										<input type='text' placeholder='Masukkan Value' class='form-control' id='qrcode_value2' name='qrcode_value2'>
									</div>
								</div>
							</div>
						</div>
					...
					<div class='form-group'>
						<label class='control-label col-lg-3'>Upload Photo Detail</label>
						<div class='col-lg-9'>
						";
								for($i=1;$i<=5;$i++){
									echo"
							<input type='file' class='form-control' id='fileDetail_".$i."' name='fileDetail_".$i."'>";
							}echo"
						</div>
					</div>
					</fieldset>
