	...
	<li class='active'><a href='".base_url()."admin/purchase/index'><i class='icon-home4'></i> <span>Dashboard</span></a></li>";
	...
	<li>
		...
		<ul>
			...
			<li><a href='".base_url("admin/master/negara")."'>Master Negara</a></li>

			<li><a href='".base_url("admin/master/provinsi")."'>Master Provinsi</a></li>

			<li><a href='".base_url("admin/master/city")."'>Master Kota</a></li>
			...
			<li><a href='".base_url("admin/master/via_expedisi")."'>Master Via Expedisi</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href='".base_url("admin/produk/mutasi_add")."'>Mutasi Stok</a></li>

			<li><a href='".base_url("admin/produk/log_mutasi")."'>History Mutasi Stok</a></li>

			<li><a href='".base_url("admin/produk/so")."'>Opname Stok</a></li>
	...
	if($_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){
	...
	if($_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){echo"
	...
	<li>
		...
		<ul>
			...
			if($_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){echo"

			<li><a href='".base_url("admin/master/kategori")."'>Master Kategori</a></li>
			<li><a href='".base_url("admin/master/user/7/".base64_encode("Member")."")."'>Master Member</a></li>";

			}

			if($_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 2){echo"
			...
			<li><a href='".base_url("admin/master/gudang")."'>Master Gudang</a></li>";}echo"
	...
	if($_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7 || $_SESSION['rick_auto']['flag_user'] == 3){echo"
	...
	<li>
		...
		<ul>";
			...
			if($_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 3){echo"
			...
			if($_SESSION['rick_auto']['flag_user'] != 7){echo"
			...
			<li><a href='".base_url("admin/produk/log_mutasi")."'>History Mutasi Stok</a></li>";}}echo"
	...
	if($_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){echo"
	...
	<li>
		...
		if($_SESSION['rick_auto']['flag_user'] != 5){
			...
			if($_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 3){
	...
	$countRPO = $this->model_purchase->getReqPurchase(0);
	...
	$countBoRPO = $this->model_purchase->getReqPurchase(1);

	$totalPBo = $countBoRPO->num_rows();
	...
	if($totalPBo == 0){
		...
		$iconBoReq = "<span class='badge badge-danger'>".$totalPBo."</span>";
	...
	if($_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 1 || $_SESSION['rick_auto']['flag_user'] == 2){
	...
	<li><a href='".base_url("admin/purchase/req_bo_index")."'><i class='icon-clipboard'></i> Back Order ".$iconBoReq."</a></li>

	";}

	if($_SESSION['rick_auto']['flag_user'] == 7){
	...
	if($_SESSION['rick_auto']['flag_user'] == 5 || $_SESSION['rick_auto']['flag_user'] == 2){
	...
	<li><a href='".base_url("admin/produk/order/barcode")."'><i class='  icon-cart-add2'></i>Order Produk</a></li>";}
	...
	<li>
		...
		<ul>	
				...
				<li><a href='".base_url("admin/purchase/monthly_report/po")."'>Report PO</a></li>

				<li><a href='".base_url("admin/invoice/report_barang/keluar")."'>Report Barang Keluar</a></li>

				<li><a href='".base_url("admin/invoice/report_rekap_invoice")."'>Report Rekap Invoice</a></li>

				<li><a href='".base_url("admin/invoice/report_retur_revisi")."'>Report Retur Revisi</a></li>

				<li><a href='".base_url("admin/purchase/report_bo")."'>Report Back Order</a></li>

				<li><a href='".base_url("admin/purchase/report_bo/qty")."'>Report Qty Back Order</a></li>
	...
	<li>
		...
		<ul>
			...
			<li><a href='".base_url("admin/purchase/monthly_report/so")."'>Report SO</a></li>";

			}echo"

			<li><a href='".base_url("admin/purchase/monthly_report/po")."'>Report PO</a></li>";

			if($_SESSION['rick_auto']['flag_user'] != 4){
			...
			if($_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){

			}elseif($_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 5 || $_SESSION['rick_auto']['flag_user'] == 1){
			...
			<li><a href='".base_url("admin/invoice/report_tanda_terima")."'>Report Tanda Terima</a></li>";

			}echo"

			<li><a href='".base_url("admin/invoice/report_barang/masuk")."'>Report Barang Masuk</a></li>
			...
			<li><a href='".base_url("admin/invoice/report_piutang")."'>Report Sisa Hutang</a></li>";

			}

			if($_SESSION['rick_auto']['flag_user'] == 1 || $_SESSION['rick_auto']['flag_user'] == 2 || $_SESSION['rick_auto']['flag_user'] == 4 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){
			...
			if($_SESSION['rick_auto']['flag_user'] == 1 || $_SESSION['rick_auto']['flag_user'] == 6 || $_SESSION['rick_auto']['flag_user'] == 7){

			echo"

			<li><a href='".base_url("admin/invoice/penjualan")."'>Report Penjualan</a></li>

			<li><a href='".base_url("admin/invoice/report_stok")."'>Report Stok</a></li>";
