...
<style>
  ...
  body{
		...
		<tr>
			...
			<td width='50%' style='padding-left: 100px'>
				...
				<tr>
                	...
                	<td>
                    	<b style='margin-top:0.3mm; font-size: 15px;'>Expedisi : ".$getInvoice->expedisi."</b>
                    </td>
              	</tr>
                <tr>    
                    <td>
                      	<b style='margin-top:0.3mm; font-size: 15px;'>Via Expedisi : ".$getInvoice->via_expedisi."</b>
                   	</td>
				</tr>
	...
	<div class='table-responsive'>
	    ...
	    <p style='font-size:15px; margin-top:0.3mm; padding-left:78%'>Jakarta, ".date("d M Y",strtotime("+0 day", strtotime(date('Y-m-d'))))."</p>
