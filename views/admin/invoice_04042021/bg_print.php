  ...
  body{
	...
	<div class='table-responsive'>
	    ...
	    <table width='100%' border='2' cellspacing='0' style='margin-top:4px'>
	        ...
	        <tbody>";
	            ...
	            <tr>
	                ...
	                <td style='height: 40px;' align='right'><span class='text-semibold'>".number_format(round($sub_tot),0,",",".")."</span></td>
		...
		// $getInvoice->total_before_ppn = $total_pembayaran - ceil($getInvoice->discount);
            ...
            $grandTotal = round($getInvoice->total + $ppn);
            ...
            <tr>
            	...
            	<td style='height: 15px; vertical-align: top;' align='right'><b>Rp. ".number_format($ppn,0,",",".")."</b></td>
