...
<style>
  body{
					...
					<td width="50%">
						<table width="100%">
								<tr>
									...
									<?php }else{
									?> 
									Via Expedisi : <?php echo $getInvoice->via_expedisi;?> <?php }?> </h3></td>
								</tr>
								<?php
	...
	<table border="0">
		...
		<tr>
			<td></td>
			<td><p style="font-size: 20px;">+62<?php echo $getCodeArea->area_code;?> <?php echo strtoupper($getInvoice->phone_member);?><br><?php echo strtoupper($getInvoice->nama_provinsi);?></p></td>
		</tr>
	</table>
	</p>
</body>
