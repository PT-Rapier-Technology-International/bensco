...
// $getInvoiceReturRevisi = $this->model_invoice->getCekReturRevisiByPerusahaan2($namaptsj,$nama_jenis);
$getInvoiceReturRevisi = $this->model_invoice->getCekReturRevisiByPerusahaan($namaptsj,$nama_jenis)->row();
$getInvoiceReturRevisi2 = $this->model_invoice->getCekReturRevisiByPerusahaan($namaptsj,$nama_jenis);
// PT.RA/00001/RET/10/20


if($getInvoiceReturRevisi2->num_rows() > 0){
/*
	$getno = explode($getInvoiceReturRevisi->nomor_retur_revisi,"/");
	$getno = $getno[1];*/
	$uniqNo = $getInvoiceReturRevisi2->num_rows();
	// $uniqNo = (int)$getno;
...
<div class='panel panel-white'>
	...
	<div class='panel-heading'>
		...
		<h6 class='panel-title'>Invoice #".str_replace("PT.E","PT.ETC",$getInvoice->nonota)."</h6>
                ...
                <div class='col-md-6'>
                    ...
                    <div class='form-group'>
                        ...
                        <label>Scan Barcode : </label>
                            ...
                            <input type='text' id='kode_produk' name='kode_produk' class='form-control input-xlg' placeholder='Input Kode Barcode' autofocus='' onchange='javascript:scan_barcode_retur_revisi(".$getInvoice->id.",".$jenis.");'>
	...
	<div class='table-responsive'>
	    ...
	    <table class='table table-lg' id='table-retur'>
	        ...
	        <tbody>";
	            ...
	            <tr>
	                ...
	                <div align='right'>
		                ...
		                <a href='#!' onclick=javascript:simpanAjaxRetur(".$detailInvoice->id.",'tdQty_".$detailInvoice->id."',".$id_invoice.",'5')><i class='icon-checkmark'></i></a>
