...
<style>
  ...
  body{
	...
	<table width='100%' cellspacing='0,4'>
		...
		<td><b style='margin-top:0.8mm; font-size: 28px; '>".strtoupper($getPerusahaan->name)."</b></td>

		<td><b style='margin-top:0.6mm; font-size: 16px;'>The Specialist For Engine Parts</b></td>

		<td align='right'><b style='margin-top:0.6mm; font-size: 20px;'>".$getInvoice->nonota."</b></td>
					...
					<td width='50%' style='height: 2px; vertical-align: top;'>
						...
						<table width='100%'>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top;'><b style='margin-left:20px'>".strtoupper($getInvoice->member_name)."</b></td>

								</tr>

								<tr>

									<td style='height: 2px; vertical-align: top;'><b style='margin-left:20px'>".$getInvoice->alamat_member."</b></td>

								</tr>

								<tr>

									<td style='height: 2px; vertical-align: top;'><b style='margin-left:20px;'>".$getInvoice->kota_member."</b></td>
					...
					<td width='50%' style='height: 2px; vertical-align: top;'>
						...
						<table width='100%'>
								...
								<tr>
									...
									<td align='right' style='height: 2px; vertical-align: top; font-size: 16px' align='left'><b><b> ".$hari[$num].", ".date("d F Y",strtotime("+0 day", strtotime($getInvoice->dateorder)))."</b></b></td>
								...
								<tr>
									...
									<td align='right' style='height: 2px; vertical-align: top;' align='left';><b><b><u>Expedisi : </u><br>".$getInvoice->expedisi."</b></b></td>
								...
								";
									if($getInvoice->via_expedisi == ""){
										...
										echo"
								<td align='right' style='height: 2px; vertical-align: top;' align='left'><b><b>Via Expedisi : ".$getInvoice->via_expedisi."</b></b></td>";
									}echo"
	...
	<div class='table-responsive'>
		...
		<table width='100%' border='2' cellspacing='0,5' style='margin-top:2px'>
	        ...
	        <thead>
	            ...
	            <tr>
	                ...
	                <th style='height: 10px; style='height: 10px; width: 100px; '>Qty</th>

	                <!--<th style='height: 10px; style='height: 10px; width: 100px; '>Harga Nett / Unit</th>-->

	                <th style='height: 10px; style='height: 10px; width: 100px; '>Diskon</th>

	                <th style='height: 10px; ' class='col-sm-2'>Harga / Unit</th>
	        ...
	        <tbody>";
	            ...
	            <tr>
                	...
                	<!--<td style='height: 25px;'>".$detailInvoice->deskripsi."</td>-->

	                <td style='height: 25px;' align='center'>".$detailInvoice->qty_kirim." ".$detailInvoice->satuan."</td>

	                <!--<td style='height: 25px;' align='center'>".number_format($detailInvoice->netprice,0,',','.')."</td>-->

	                <td style='height: 25px;' align='center'>".$disc."%</td>

	                <td style='height: 25px;' align='right'>".number_format(ceil($detailInvoice->price),0,',','.')."</td>

	                <td style='height: 25px;' align='right'><span class='text-semibold'>".number_format(ceil($detailInvoice->ttl_price),0,',','.')."</span></td>
	            ...
	            <!--<tr>
	                ...
	                <td style='height: 25px;' colspan='5'>
	                	...
	                	<b>".$detailInvoice->product_code."</b>
	    ...
	    <tr>
            ...
            <tr>
            	...
            	<td style='height: 15px; vertical-align: top;' align='right'><b>Rp. ".number_format(ceil($grandTotal),0,',','.')."</b></td>
