	...
	<div class="table-responsive">
	    ...
	    <table width="100%" border="1" cellspacing="0" style="margin-top:4px">
	        ...
	        <tbody>
	        	...
	        	foreach($getInvoiceDetail->result() as $detailInvoice){
	        		...
	        		$total_pembayaran = round($total_pembayaran + $detailInvoice->ttl_price);
	            ...
	            <tr>
	                ...
	                <td style='height: 40px;' align='center'><?php echo floor($disc) ?>%</td>

	                <td style="height: 10px;" align="right"><?php echo number_format(round($detailInvoice->price),0,",",".");?></td>

	                <td style="height: 10px;" align="right"><span class="text-semibold"> <?php echo number_format(round($detailInvoice->ttl_price),0,",",".");?></span></td>
	    ...
	    ?>
            ...
            <tr>
            	...
            	<td style="height: 10px; vertical-align: top;" align="right"><b>Rp. <?php echo number_format($afterdiskon,0,',','.'); ?></b></td>
            ...
            $grandTotal = round($getInvoice->total_before_ppn + $ppn);
            ...
            <tr>
            	...
            	<td style="height: 15px; vertical-align: top;" align="right"><b>Rp. <?php echo number_format(round($grandttl),0,",","."); ?></b></td>
