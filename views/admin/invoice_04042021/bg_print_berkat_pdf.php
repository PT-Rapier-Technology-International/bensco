					...
					<td width="50%" style="height: 2px; vertical-align: top;">
						...
						<table width="100%">
								...
								<tr>
									...
									<td style="height: 2px; vertical-align: top;"><b style="margin-left:20px"><?php echo strtoupper($getInvoice->member_name); ?></b></td>
		...
		<table width="100%" border="1" cellspacing="0,5" style="margin-top:2px">
	        ...
	        <thead>
	            ...
	            <tr>
	               ...
	               <!--  <th style="height: 10px; width: 100px; ">Keterangan</th> -->
	                ...
	                <th style="height: 10px; " class="col-sm-1">Harga Total</th>
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td style='height: 40px;' align='center'><?php echo $detailInvoice->dsc; ?>%</td>
