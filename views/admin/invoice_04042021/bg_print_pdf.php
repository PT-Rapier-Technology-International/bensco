					...
					<td width="50%" style="height: 2px; vertical-align: top;">
						...
						<table width="100%">
								...
								<tr>
									...
									<td style="height: 2px; vertical-align: top; font-size: 12px" align="left"><b><b>Faktur No : <?php echo $getInvoice->nonota;?></b></b></td>
								...
								<tr>
									...
									<td style="height: 2px; vertical-align: top; font-size: 12px" align="left"><b><b>Hari / Tgl : <?php echo $hari[$num];?>, <?php echo date("d F Y",strtotime("+0 day", strtotime($getInvoice->dateorder)));?></b></b></td>

								</tr>

								<tr>

									<td style="height: 2px; vertical-align: top; font-size: 12px" align="left"><b><b>Expedisi : <?php echo $getInvoice->expedisi;?></b></b></td>
								...
								<tr>
									...
									if($getInvoice->via_expedisi == ""){
										...
										?>
									<td style="height: 2px; vertical-align: top; font-size: 12px" align="left"><b><b>Via Expedisi : <?php echo $getInvoice->via_expedisi;?></b></b></td>
								<?php } ?>
	...
	<div class="table-responsive">
	    ...
	    <table width="100%" border="1" cellspacing="0" style="margin-top:4px">
	        ...
	        <thead>
	            ...
	            <tr>
	                ...
	                <th style="height: 20px;" align="center" class="col-sm-1"><b>Diskon</b></th>
	    ...
	    <table width="100%" border="0" cellspacing="0">
            ...
            <tr>
            	...
            	<td style="height: 10px; vertical-align: center;" rowspan="9"><b><b>TOTAL PEMBAYARAN</b></b></td>
		...
		?>
            ...
            <tr>
            	...
            	<td style="height: 10px; vertical-align: top;" colspan="3"><b>TOTAL JUMLAH FAKTUR </b></td>

            	<td style="height: 10px; vertical-align: top;" align="right"><b>Rp. <?php echo number_format($grandTotal,0,",","."); ?></b></td>
