...
<table width='100%'>
	...
	<tr>
		...
		<th align='right'>".date("d M Y", strtotime("+0 day", strtotime($dataRR->row()->tgl)))." <br> Nama Customer : ".$dataRR->row()->nama_member." <br> ".$dataRR->row()->nama_kota." <br> Ex_Inv : ".$dataRR->row()->no_nota."</th>
