...
<style type='text/css'>
		...
		echo "<table width='100%' border='1' cellspacing='0' style='font-family:calibri;'>";
			...
			if($temp_tgl != date('F', strtotime($member->dateorder))." ".date("Y",strtotime("+0 day", strtotime($member->dateorder))))
			{
				...
				echo "<tr>
						...
						<th style='width:14%'><p style='font-size:11px;'>TANGGAL INVOICE</p></th>
						...
						<th style='width:14%'><p style='font-size:11px;'>KETERANGAN</p></th>

            			<!--<th style='width:14%'><p style='font-size:11px;'>Kode Member</p></th>-->
		...
		<tr>
			...
			foreach($dataPrint->result() as $print){
				...
				<tr>
					...
					<td style='font-size: 11px' align='center' width='14%' width='15%'></td>

          			<td style='font-size: 11px' align='center' width='16%' width='15%'></td>
					...
					<td style='font-size: 11px' width='15%'>".$st_bayar."</td>
			...
			echo"
				...
				<tr class='hide_all'>
					...
					<td colspan='2' align='center' style='font-size: 11px; border: none;'><b>AMOUNT GIRO</b></td>

					<td style='border: none;'></td>

					<td align='center' style='font-size: 11px'><b>".number_format($totalAmount,2,',','.')."</b></td>
	...
	<table width='100%' border='1' cellspacing='0'>
				...
				<tr class='hide_all'>
					...
					<td colspan='2' align='center' style='font-size:11px; border:none;'><b>GRAND TOTAL</b></td>


					<td style='border: none;'></td>
					<td align='center' style='font-size: 11px;'><b>".number_format($grandTotal,2,',','.')."</b></td>
					<td style='border: none;'></td>
					<td style='border: none;'></td>
					<td style='border: none;'></td>
...
";
	...
	<table width="100%" border="1" cellspacing="0">
		...
		<tr>
			...
			<th><p style='font-size:15px;'>TANGGAL INVOICE</p></th>

			<th><p style='font-size:15px;'>NO INVOICE</p></th>

			<th><p style='font-size:15px;'>AMOUNT</p></th>

			<th><p style='font-size:15px;'>TANGGAL GIRO</p></th>

			<th><p style='font-size:15px;'>GIRO</p></th>

			<th><p style='font-size:15px;'>KETERANGAN</p></th>
		...
		<tr>
			...
			<td colspan='5'>
			<p style='font-size:19px; border: none;'><b>".$member->member_name." - ".$member->kota."</b></p>
			</td>
		...
		";
			...
			foreach($dataPrint->result() as $print){
				...
				<tr>
					...
					<td align='center'>".str_replace("PT.E","PT.ETC",$print->nonota)."</td>
