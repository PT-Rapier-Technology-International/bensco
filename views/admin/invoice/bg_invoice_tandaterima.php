	...
	<div class='panel panel-flat'>
		...
		<div class='panel-heading col-sm-12'>
			...
			if(isset($_SESSION['rick_auto']['filter_invoice_no_tt'])){
				...
				<input type='text' class='form-control' placeholder='No. Invoice' id='invoice_no_tt' name='invoice_no_tt' value='".str_replace("PT.E","PT.ETC",$sess)."'>
			</div>
			<div class='col-sm-1' style='margin-top:1%'>
				No Tanda Terima
			</div>
			...
			if(isset($_SESSION['rick_auto']['filter_no_tt'])){
				...
				<input type='text' class='form-control' placeholder='No. Tanda Terima' id='tt_no' name='tt_no' value='".str_replace("PT.E","PT.ETC",$sesstt)."'>
			</div>
			<div class='col-sm-1' style='margin-top:1%'>
				Perusahaan
			</div>
			...
			foreach($Data->result() as $data){
				...
				<tr>
					...
					foreach ($getInv->result() as $inv) {
						echo"
						<tr>
							<td>".str_replace("PT.E","PT.ETC",$inv->no_nota)."</td>
						</tr>
						";
					}
					echo"
