...
<style>
  ...
  body{
	...
	<hr style='margin-bottom:0.3mm'>
		...
		<b style='margin-top:0.3mm; font-size: 32px;'>".strtoupper($getPerusahaan->name)."</b>
	...
	<table width='100%' cellspacing='0'>
		...
		<tr>
					...
					<td width='50%' style='height: 2px; vertical-align: top;'>
						...
						<table width='100%'>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top;'><b>".strtoupper($getInvoice->nama_member)."</b></td>
			...
			<td style='height: 2px; vertical-align: top; float:right; right:0;'>
					...
					<td width='50%' style='height: 2px; vertical-align: top;'>
						...
						<table width='100%'>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top; font-size: 19px' align='left'><b><b>Faktur No : ".$getInvoice->nonota."</b></b></td>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top; font-size: 17px' align='left'><b><b>Hari/Tgl : ".$hari[$num].", ".date("d F Y",strtotime("+0 day", strtotime($getInvoice->dateorder)))."</b></b></td>

								</tr>

								<tr>

									<td style='height: 2px; vertical-align: top; font-size: 13px' align='left'><b><b>Expedisi : ".$getInvoice->expedisi."</b></b></td>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top; font-size: 13px' align='left'><b><b>Via Expedisi : ".$getInvoice->via_expedisi."</b></b></td>";
									}echo"
	...
	<div class='table-responsive'>
	    ...
	    <table width='100%' border='2' cellspacing='0' style='margin-top:4px'>
	        ...
	        <tbody>";
	        	...
	        	foreach($getInvoiceDetail->result() as $detailInvoice){
	        		...
	        		$total_pembayaran = $total_pembayaran + $sub_tot;
	            ...
	            <tr>
	                ...
	                <td style='height: 40px;' align='right'>".number_format(ceil($detailInvoice->price),0,",",".")."</td>

	                <!--<td style='height: 40px;' align='right'>".$diskon."%</td>-->

	                <td style='height: 40px;' align='right'><span class='text-semibold'>".number_format(ceil($sub_tot),0,",",".")."</span></td>
	    ...
	    <table width='100%' border='0' cellspacing='0'>
            ...
            <tr>
            	...
            	<td style='height: 15px; vertical-align: center;' rowspan='9'><b><b>TOTAL PEMBAYARAN</b></b></td>
		...
		$getInvoice->total_before_ppn = $total_pembayaran - ceil($getInvoice->discount);
			...
			<tr>
				...
				<td style='height: 15px; vertical-align: top;' align='right'><b>Rp. ".number_format(ceil($getInvoice->discount),0,',','.')."</b></td>
			...
			<td style='height: 15px; vertical-align: top;' align='right'><b>Rp. ".number_format(ceil($getInvoice->total_before_ppn),0,',','.')."</b></td>
            ...
            <tr> 
            	...
            	<td style='height: 15px; vertical-align: top;' align='right'><b>Rp. ".number_format(ceil($getInvoice->total),0,",",".")."</b></td>
