...
// header("Content-Disposition: attachment; filename=SuratJalan_".date('d M y').".pdf");
...
<body>
	<p align="center"><font size="12"><b><U>SURAT JALAN</font></U></b>

	<br><?php echo $getInvoiceRow->nonota;?>
		...
		<tr>
			...
			<table width="100%">
				...
				<tr>
					...
					<td><b><?php echo strtoupper($getMember->name); ?></b></td>
				...
				<tr>
					...
					<td><b><?php echo strtoupper($getMember->address_toko); ?></b></td>
				...
				<tr>
					...
					<td><b><?php echo strtoupper($getMember->city); ?></b></td>
			...
			<table width="100%" border="1">
				...
				<tr>
					...
					<td align="right"><?php echo $getInvoiceRow->expedisi;?></td>
				...
				<tr>
					...
					<td align="right"><?php echo $getInvoiceRow->via_expedisi;?></td>
	    ...
	    <table width="100%" border="1" cellspacing="0">
	        ...
	        <tbody>
	            ...
	            <tr>
	            	...
	            	<td style='height: 25px; vertical-align: center; font-size: 14px;' align='center'>".$invoice->qty_kirim." ".$invoice->satuan."</td>

	                <td style='height: 25px; vertical-align: center; font-size: 14px;'>".$invoice->deskripsi."</td>

                	<td style='height: 25px; vertical-align: center; font-size: 14px;'>".$invoice->product_name."</td>
	    		...
	    		<td>
	    			...
	    			<table>
	    				...
	    				<tr>
	    					...
	    					<td><p><b><?php echo strtoupper($getMember->name); ?></b></p></td>
	    		...
	    		<td align='right'>
	    			...
	    			<table>
	    				...
	    				<tr>
	    					...
	    					<td align='center'><p><b><?php echo strtoupper($getPerusahaan->name); ?></b></p></td>
