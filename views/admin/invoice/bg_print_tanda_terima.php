	    ...
	    <table width='100%' border='1' cellspacing='0'>
	        ...
	        <tbody>";
	            ...
	            <tr height='25px'>
                	...
                	<td align='right' style='font-size:13px;'>Rp. ".number_format($grandTotal,0,',','.')."</td>
	            ...
	            <tr height='25px'>
	            	...
	            	<td rowspan='6' colspan='5'><p style='font-size:14px; text-align:center;'><b>TOTAL PEMBAYARAN</b></p></td>

	            	<td align='right' style='height: 15px;'><p style='font-size:14px;'><b>Rp. ".number_format($total_pembayarans,0,',','.')."</b></p></td>
	        ...
	        <tbody>";
	            ...
	            <tr height='30px'>
	                ...
	                <td align='right' style='font-size:13px;'>Rp. ".number_format($grandTotal,2,',','.')."</td>
