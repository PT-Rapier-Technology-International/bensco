					...
					<td width='50%' style='height: 2px; vertical-align: top;'>
						...
						<table width='100%'>
								...
								<tr>
									...
									<td style='height: 2px; vertical-align: top;'><b style='margin-left:20px'>".strtoupper($getInvoice->nama_member)."</b></td>
		...
		<table width='100%' border='2' cellspacing='0,5' style='margin-top:2px'>
	        ...
	        <thead>
	            ...
	            <tr>
	                ...
	                <!--<th style='height: 10px;' class'col-sm-2'>Include Diskon</th>-->
	        ...
	        <tbody>";
	            ...
	            <tr>
	                ...
	                <td style='height: 25px;' align='right'>".number_format(ceil($detailInvoice->price),0,',','.')."</td>
	                 ...
	                 <!--<td style='height: 25px;' align='right'>".$diskon."%</td>-->
