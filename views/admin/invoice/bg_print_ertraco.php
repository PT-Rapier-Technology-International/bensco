...
<style>
  ...
  body{
	...
	<table width='100%' cellspacing='0'>
		...
		<td width='60%'><b style='margin-top:0.3mm; font-size: 33px;'>".strtoupper($getPerusahaan->name)."</b></td>

		<td><b style='margin-top:0.3mm; font-size: 17px;'>Faktur No : ".str_replace("PT.E","PT.ETC",$getInvoice->nonota)."</b><br>";
	    ...
	    <table width='100%' border='2' cellspacing='0' style='margin-top:4px'>
	        ...
	        <tbody>";
	            ...
	            <tr>
	                ...
	                <td style='height: 40px;' align='right'><span class='text-semibold'>".number_format(ceil($detailInvoice->ttl_price),0,',','.')."</span></td>
		...
		<table border='0' width='100%'>
	    	...
	    	<tr>
				...
				<td style='height: 15px; vertical-align: bottom;'>";
		    		...
		    		<p style='font-size:10px; padding-left:83%; margin-top:15%'>".$hari[$nums].", ".date("d F Y",strtotime("+0 day", strtotime($changeTanggal)))."</p>
