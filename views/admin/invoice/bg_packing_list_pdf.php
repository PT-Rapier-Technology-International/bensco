...
header("Content-Disposition: attachment; filename=Packing_List_".date('d M y').".xls");
...
<body>
	...
	<tr>
		...
		<b style="margin-top:0.3mm; font-size: 25px;"><?php echo strtoupper($getPerusahaan->name);?></b>
		...
		<tr>
					...
					<td width="50%" style="height: 2px; vertical-align: top;">
						...
						<table width="100%">
								...
								<tr>
									...
									<td style="height: 2px; vertical-align: top;"><b><?php echo strtoupper($getInvoice->member_name);?></b></td>
			...
			<td width="50%" style="padding-left: 100px">
				...
				<tr>
                	...
                	<td>
                    	<b style="margin-top:0.3mm; font-size: 15px;">Expedisi : <?php echo $getInvoice->expedisi;?></b>
                    </td>
              	</tr>
                <tr>    
                    <td>
                      	<b style="margin-top:0.3mm; font-size: 15px;">Via Expedisi : <?php echo $getInvoice->via_expedisi;?></b>
                   	</td>
				</tr>
	...
	<div class="table-responsive">
	    ...
	    <table width="100%" border="1" cellspacing="0" style="margin-top:4px">
	        ...
	        <tbody>
	            ...
	            <tr>
	            	...
	            	<td style='height: 25px; text-align: center; font-size: 14px'>".$detailInvoice->colly." - ".$detailInvoice->colly_to."</td>

	            	<td style='height: 25px; text-align: center; font-size: 14px'>".$detailInvoice->weight." Kg</td>

	                <td style='height: 25px; text-align: center; font-size: 14px'>".$detailInvoice->qty_kirim." ".$detailInvoice->satuan."</td>

                	<td style='height: 25px; font-size: 14px'>".$detailInvoice->deskripsi."</td>
		...
		<p style="font-size:10px">Print By : <?php echo $_SESSION["rick_auto"]["username"];?> , <?php echo date("d M Y H:i:s",strtotime("+0 day", strtotime(date("Y-m-d H:i:s"))));?></p>

		

	    <p style="font-size:15px; margin-top:0.3mm; padding-left:78%">Jakarta, <?php echo date("d M Y",strtotime("+0 day", strtotime(date("Y-m-d"))));?></p>
