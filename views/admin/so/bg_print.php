...
echo "<p style='font-size: 12;'>".date("d/m/Y") . "
</p>
	<center>
	    ...
	    <table width='100%' border='1' cellspacing='0'>
	        ...
	        <tbody>";
	            ...
	            <tr>
                	...
                	<td align='center' style='font-size: 14;'>".$detail->qtyProduk." ".$detail->nama_satuan."</td>

                	<td align='center' style='font-size: 14;'>".$detail->qtySO." ".$detail->nama_satuan."</td>
