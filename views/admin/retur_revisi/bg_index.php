	...
	<div class='panel panel-flat'>
		...
		<div class='col-sm-12'>
			...
			if(isset($_SESSION['rick_auto']['filter_invoice_no_rr'])){
				...
				<input type='text' class='form-control' placeholder='No. Invoice' id='invoice_no' name='invoice_no' value='".str_replace("PT.E","PT.ETC",$sess)."'>
			</div>
			<div class='col-sm-1' style='margin-top:1%'>
				Perusahaan
			</div>
		...
		<div class='col-sm-12' style='margin-top:2%'>
			...
			if(isset($_SESSION['rick_auto']['filter_no_retur_revisi'])){
				...
				<input type='text' class='form-control' placeholder='No. Retur Revisi' id='rr_no' name='rr_no' value='".str_replace("PT.E","PT.ETC",$sesss)."'>
			</div>
			<div class='col-sm-2'>
		...
		<table class='table'>
			...
			foreach($getData->result() as $data){
				...
				<tr>
					...
					<td><a href='".base_url("admin/invoice/retur_revisi/".base64_encode($data->id)."")."'>".str_replace("PT.E","PT.ETC",$data->nonota)."</a><br>".$iconCekHistory."</td>
					<td>".$data->perusahaan_name."</td>
					<td>".$data->nama_lengkap_member." - ".$data->kota."</td>
					<td>".str_replace("PT.E","PT.ETC",$data->no_tt)."</td>
