...
<?php
	...
	<tr>
		...
		<td style='width:10%; font-size:14px;'>".$dataDetail->sales_name."</td>";
		...
		<td style='width:10%'>".strtoupper($dataBayar->jenis_pembayaran)." ".$tanggal_cair."</td>
	...
	<tr>
		...
		<td style='width:3%'>$noo</td>

		<td style='width:10%'>".$dataDetailOri->nonota."</td>

		<td style='width:10%; font-size:14px;'>".$dataDetailOri->member_name." - ".$dataDetailOri->kota_member."</td>

		<td style='width:10%; font-size:14px;'>".$dataDetailOri->sales_name."</td>
