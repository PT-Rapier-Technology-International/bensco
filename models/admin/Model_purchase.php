...
class Model_purchase extends CI_Model {
	...
	public function getReqPurchaseCancelled(){
			...
			// if(isset($_SESSION['rick_auto']['rpo_sales_filter']) && $_SESSION['rick_auto']['rpo_sales_filter'] != '0' && $_SESSION['rick_auto']['rpo_sales_filter'] != ''){

			// 	$this->db->where('tp.sales_id',$_SESSION['rick_auto']['rpo_sales_filter']);
