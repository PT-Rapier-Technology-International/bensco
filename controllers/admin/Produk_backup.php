...
class Produk extends CI_Controller {
    ...
    public function filterPerusahaanMutasi(){
        ...
        if($tanggalFrom == "1970-01-01" || $tanggalTo == "1970-01-01" || $tanggalTo == "1970-01-02"){
            ...
            $_SESSION['rick_auto']['filter_end_date_lt'] = date("Y-m-d",strtotime("+1 day",strtotime($tanggalTo)));
    ...
    public function filterLogAdjustment(){
        ...
        if($tanggalFrom == "1970-01-01" || $tanggalTo == "1970-01-01" || $tanggalTo == "1970-01-02"){
            ...
            $_SESSION['rick_auto']['filter_end_date_la'] = date("Y-m-d",strtotime("+1 day",strtotime($tanggalTo)));
 ...
 public function simpanEditPembuatanSO(){
    ...
    public function simpanPembuatanOrder(){
        ...
        if($insert_1){
            ...
            for($i=1;$i<=$jmlProduk;$i++){
                ...
                $insert_2 = $this->db->set('produk_beli_id',$idRecent)->set('produk_id',$cmbProduk)->set('qty',$addStok)->set('perusahaan_id',$cmbPerusahaan)->set('gudang_id',$cmbGudang)->set('create_date',date("Y-m-d H:i:s"))->set('create_user',$_SESSION['rick_auto']['username'])->insert('produk_beli_detail');
    ...
    public function simpanPembuatanOrderBarcode(){
        ...
        $insert_1 = $this->db->set('notransaction',$noFakturPabrik)->set('factory_name',$namaPabrik)->set('status',$st)->set('faktur_date',date("Y-m-d",strtotime("+0 day", strtotime($tglFaktur))))->set('warehouse_date',date("Y-m-d"))->set('create_date',date("Y-m-d H:i:s"))->set('create_user',$_SESSION['rick_auto']['username'])->insert('produk_beli');
        ...
        if($insert_1){
            ...
            foreach($getDataTemp->result() as $dataTemp){
                ...
                $insert_2 = $this->db->set('produk_beli_id',$idRecent)->set('produk_id',$dataTemp->produk_id)->set('qty',$addStok)->set('perusahaan_id',$cmbPerusahaan)->set('gudang_id',$cmbGudang)->set('create_date',date("Y-m-d H:i:s"))->set('create_user',$_SESSION['rick_auto']['username'])->insert('produk_beli_detail');
    ...
    public function simpanPembuatanOrderEdit_(){
        ...
        $update_1 = $this->db->set('factory_name',$namaPabrik)->set('faktur_date',date("Y-m-d",strtotime("+0 day", strtotime($tglFaktur))))->set('warehouse_date',date("Y-m-d",strtotime("+0 day", strtotime($tglSampaiGudang))))->where('id',$id)->update('produk_beli');
        ...
        if($update_1){
            ...
            foreach ($getDataDetail->result() as $detail) {
                ...
                $update_2 = $this->db->set('produk_id',$cmbProdukEdit)->set('qty_receive',$addStokEdit)->set('perusahaan_id',$cmbPerusahaan)->set('gudang_id',$cmbGudang)->where('id',$detail->id)->update('produk_beli_detail');
    ...
    public function approveOrder(){
        ...
        $getDataDetail = $this->model_produk->getProdukBeliDetailByIdProdukBeli($id);
            ...
            if($insert){
                ...
                $update = $this->db->set('flag_proses',1)->set('note',$txtNote)->set('approve_user',$_SESSION['rick_auto']['username'])->where('id',$id)->update('produk_beli');
    ...
    public function simpanPembuatanMutasi(){
        ...
        for($i=1; $i<=$jmlProduk; $i++){
            ...
            if($cmbProduk == 0 || $cmbProduk == NULL || $cmbProduk == "NULL" || $cmbProduk == "0" || $cmbGudangFrom == 0 || $cmbGudangFrom == NULL || $cmbGudangFrom == "NULL" || $cmbGudangFrom == "0"){
                ...
                $insertLog1 = $this->db->set('no_transaction',$txtNoT)->set('product_perusahaan_gudang_id',$getProductPerusahaanGudang->id)->set('from_perusahaan_id',$cmbPerusahaanFrom)->set('from_gudang_id',$cmbGudangFrom)->set('to_perusahaan_id',$cmbPerusahaanFrom)->set('to_gudang_id',$cmbGudangTo)->set('from_stok',$getDataStok->row()->jmlStok)->set('to_stok',$addStok)->set('create_date',$txtTglMutasi)->set('create_user',$_SESSION['rick_auto']['username'])->insert('log_stok');

                if($insertLog1){

                    //$update = $this->db->set('stok',$getPenguranganStok)->where('perusahaan_gudang_id',$getPerusahaanGudang->id)->where('product_id',$cmbProduk)->update('product_perusahaan_gudang');
