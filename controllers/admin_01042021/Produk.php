 ...
 public function simpanEditPembuatanSO(){
    ...
    public function simpanPembuatanOrderBarcode(){
        ...
        if($insert_1){
            ...
            foreach($getDataTemp->result() as $dataTemp){
                $addStok = $this->input->post('addStok_'.$dataTemp->id);
                $insert_2 = $this->db->set('produk_beli_id',$idRecent)->set('produk_id',$dataTemp->produk_id)->set('qty',$addStok)->set('qty_receive',-1)->set('perusahaan_id',$cmbPerusahaan)->set('gudang_id',$cmbGudang)->set('create_date',date("Y-m-d H:i:s"))->set('create_user',$_SESSION['rick_auto']['username'])->insert('produk_beli_detail');
            }
                echo "1";
            }
        }
